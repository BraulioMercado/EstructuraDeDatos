        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                try
                {
                    ...
                    OcMayor = valores.Max();
                    Posicion = valores.ToList().IndexOf(valores.Max());
                    Console.WriteLine("El valor de la ocurrencia mayor es {0} y su posicion es {1}.", OcMayor, Posicion + 1);
                    ban = false;
                }
                catch (Exception e)
                {
